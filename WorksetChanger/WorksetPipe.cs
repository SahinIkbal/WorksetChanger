...
namespace WorksetChanger
{
    ...
    class WorksetPipe : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var ws = worksets.FirstOrDefault(x => x.Name == "A_Pipe") ?? worksets.FirstOrDefault();

            var elementsToChange = new FilteredElementCollector(doc).OfClass(typeof(Pipe));
