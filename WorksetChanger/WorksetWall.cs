...
namespace WorksetChanger
{
    ...
    class WorksetWall : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var ws = worksets.FirstOrDefault(x => x.Name == "A_ArchWall") ?? worksets.FirstOrDefault();

            var elementsToChange = new FilteredElementCollector(doc).OfClass(typeof(Wall)).WherePasses(new StructuralWallUsageFilter(StructuralWallUsage.NonBearing));
